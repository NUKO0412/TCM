...
export const supabase = createClient(
  ...
  anonKey ?? 'placeholder-anon-key',
  {
    ...
    // /reinitialisation traite explicitement les jetons de récupération.
    // On évite un double traitement global qui peut rendre le parcours instable
    // selon le navigateur, le cache et la session locale.
