...
describe('SeoPage', () => {
  ...
  it('affiche toutes les cartes SEO et les pastilles aide', () => {
    ...
    expect(screen.getByText('Performance sur les 28 derniers jours')).toBeInTheDocument()
    expect(screen.getByText('Nombre total de clics')).toBeInTheDocument()
    expect(screen.getByText('Nombre total d’impressions')).toBeInTheDocument()
    expect(screen.getByText('CTR moyen')).toBeInTheDocument()
    expect(screen.getByText('3,5 %')).toBeInTheDocument()
    expect(screen.getByText('Top pages')).toBeInTheDocument()
    expect(screen.getByText('07/07/2026 11:15')).toBeInTheDocument()
    expect(screen.getByText('4,2')).toBeInTheDocument()
    expect(screen.queryByText('Période analysée')).toBeNull()
    expect(screen.queryByText(/2026-06-07 → 2026-07-04/)).toBeNull()
